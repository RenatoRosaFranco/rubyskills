...
module RubySkills
  # Turns a declared legacy skill into a local directory that can be installed.
  #
  ...
  #
  # The registry Skillfile resolver is {RubySkills::Resolver}.
  #
  ...
  #   )
  #   RubySkills::LegacyResolver.new.resolve(skill)
  #
  # @api private
